...
- [paperclip-goals-workspace](https://github.com/marospekarik/paperclip-goals-workspace) - Turns the Goals page into a full goal-management workspace: owner and parent reassignment, FK-safe deletion, project and task linking, and progress rolled up through the tree. [npm](https://www.npmjs.com/package/paperclip-goals-workspace)
